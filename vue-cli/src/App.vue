<template>
  ...
  <div class="footer">
    <div class="row align--center">
      <span class="mr-2">© RaviAnand Mohabir, 2021</span>
      <a href="https://www.linkedin.com/in/ravianand-mohabir/" target="_blank">
        <svg viewBox="0 0 128 128" class="va-icon icon">
          <path
            fill="#0076b2"
    ...
    <a
      href="https://github.com/Dan6erbond/qv-checker"
      class="row align--center justify--end"
      target="_blank"
    >
      <svg viewBox="0 0 128 128" class="mr-2 va-icon icon">
        <g fill="#181616">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
